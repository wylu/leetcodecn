...
/**
 * @File    :   1482.制作-m-束花所需的最少天数.cpp
 * @Time    :   2021/05/10 11:27:40
 * @Author  :   wylu
 * @Version :   1.0
...
public:
    int minDays(vector<int>& bloomDay, int m, int k) {
        int MAX_DAY = 0;
        for (auto day : bloomDay) MAX_DAY = max(MAX_DAY, day);
