...
func PredictTheWinner(nums []int) bool {
	...
	return dfs486(nums, 0, n-1, &cache) >= 0
}

func dfs486(nums []int, l, r int, cache *[][]int) int {
	if (*cache)[l][r] != -1 {
		return (*cache)[l][r]
	}
	...
	(*cache)[l][r] = max486(nums[l]-dfs486(nums, l+1, r, cache),
		nums[r]-dfs486(nums, l, r-1, cache))
	return (*cache)[l][r]
}

func max486(x, y int) int {
	if x > y {
		return x
	}
	return y
