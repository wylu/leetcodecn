...
class Solution:
    def canCross(self, stones: List[int]) -> bool:
        ...
        pos = {sto: idx for idx, sto in enumerate(stones)}
...
if __name__ == '__main__':
    ...
    print(solu.canCross(stones=[0, 1, 2, 3, 4, 8, 9, 11]))
    print(solu.canCross(stones=[0, 2]))
