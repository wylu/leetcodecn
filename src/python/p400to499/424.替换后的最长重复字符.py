    ...
    def characterReplacement(self, s: str, k: int) -> int:
        ...
        while right < n:
            ...
            if right - left > max_cnt + k:
                # 说明此时 k 不够用，把其它不是最多出现的字符替换以后，
                # 都不能填满这个滑动的窗口，这个时候须要考虑左边界向右移动
...
if __name__ == "__main__":
    solu = Solution()
    print(solu.characterReplacement(s="ABAB", k=2))
    print(solu.characterReplacement(s="AABABBA", k=1))
