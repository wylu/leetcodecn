...
if __name__ == "__main__":
    solu = Solution()
    print(solu.smallestSubsequence("cdadabcc"))
    print(solu.smallestSubsequence("abcd"))
    print(solu.smallestSubsequence("ecbacba"))
    print(solu.smallestSubsequence("leetcode"))
