...
# -*- coding: utf-8 -*-
"""
@File    :   1370.上升下降字符串.py
@Time    :   2020/11/25 13:19:07
@Author  :   wylu
@Version :   1.0
...
if __name__ == "__main__":
    solu = Solution()
    print(solu.sortString("aaaabbbbcccc"))
    print(solu.sortString("rat"))
    print(solu.sortString("leetcode"))
    print(solu.sortString("ggggggg"))
    print(solu.sortString("spo"))
