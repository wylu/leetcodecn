...
if __name__ == "__main__":
    solu = Solution()
    print(solu.createTargetArray([0, 1, 2, 3, 4], [0, 1, 2, 2, 1]))
    print(solu.createTargetArray([1, 2, 3, 4, 0], [0, 1, 2, 3, 0]))
    print(solu.createTargetArray([1], [0]))
