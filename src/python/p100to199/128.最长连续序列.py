...
if __name__ == '__main__':
    solu = Solution()
    print(solu.longestConsecutive(nums=[100, 4, 200, 1, 3, 2]))
    print(solu.longestConsecutive(nums=[0, 3, 7, 2, 5, 8, 4, 6, 0, 1]))
    print(solu.longestConsecutive(nums=[1, 2, 0, 1]))
