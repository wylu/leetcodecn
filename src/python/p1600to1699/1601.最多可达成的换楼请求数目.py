...
# 的员工数数目。比方说 n = 3 且两个员工要离开楼 0 ，一个员工要离开楼 1 ，一个员工要离开楼 2 ，如果该请求列表可行，应该要有两个员工搬入楼 0
# ，一个员工搬入楼 1 ，一个员工搬入楼 2 。
#
...
if __name__ == '__main__':
    ...
    print(solu.maximumRequests(n, requests))
