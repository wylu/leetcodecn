...
# -*- coding: utf-8 -*-
"""
@File    :   1621.大小为-k-的不重叠线段的数目.py
@Time    :   2020/10/29 09:17:09
@Author  :   wylu
@Version :   1.0
...
class Solution:
    def numberOfSets(self, n: int, k: int) -> int:
        ...
        return (f[n - 1][k][0] + f[n - 1][k][1]) % 1000000007
...
if __name__ == "__main__":
    solu = Solution()
    print(solu.numberOfSets(4, 2))
    print(solu.numberOfSets(3, 1))
    print(solu.numberOfSets(30, 7))
