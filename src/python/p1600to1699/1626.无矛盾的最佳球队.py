...
# -*- coding: utf-8 -*-
"""
@File    :   1626.无矛盾的最佳球队.py
@Time    :   2020/10/27 22:38:02
@Author  :   wylu
@Version :   1.0
...
if __name__ == "__main__":
    solu = Solution()
    print(solu.bestTeamScore([1, 3, 5, 10, 15], [1, 2, 3, 4, 5]))
    print(solu.bestTeamScore([4, 5, 6, 5], [2, 1, 2, 1]))
    print(solu.bestTeamScore([1, 2, 3, 5], [8, 9, 10, 1]))
