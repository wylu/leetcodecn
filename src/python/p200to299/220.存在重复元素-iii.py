...
if __name__ == '__main__':
    solu = Solution()
    print(solu.containsNearbyAlmostDuplicate([1, 2, 3, 1], k=3, t=0))
    print(solu.containsNearbyAlmostDuplicate([1, 0, 1, 1], k=1, t=2))
    print(solu.containsNearbyAlmostDuplicate([1, 5, 9, 1, 5, 9], k=2, t=3))
