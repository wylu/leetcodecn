...
class Solution:
    def isPossible(self, nums: List[int]) -> bool:
        cnts, ends = defaultdict(int), defaultdict(int)
...
if __name__ == "__main__":
    solu = Solution()
    print(solu.isPossible([1, 2, 3, 3, 4, 5]))
    print(solu.isPossible([1, 2, 3, 3, 4, 4, 5, 5]))
    print(solu.isPossible([1, 2, 3, 4, 4, 5]))
